...
**Attention-as-a-Service for your private data: multimodal semantic search over you and your team's knowledge base — the corpus stays out of the conversation.** Login to send invites and share access at [knowdrive.ai](https://knowdrive.ai). Just add "check KnowDrive". Hybrid search ranks passages from docs, audio, and images.
...
Start with **Connect directly** — it's fewer steps and needs no key. Reach for the [npm bridge](#npm-bridge-stdio--headless) when your client only speaks stdio, or when you're wiring this into CI where a browser sign-in isn't possible.
...
[![npm](https://img.shields.io/npm/v/@knowdrive/mcp?style=for-the-badge&logo=npm&color=CB3837)](https://www.npmjs.com/package/@knowdrive/mcp)
